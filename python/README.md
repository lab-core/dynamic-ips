...
itself is the C++ code [`here`](../cpp/README.md). For an
...
[C++ solver README](../cpp/README.md) for build instructions and how
to run, and the
...
- [C++ solver README](../cpp/README.md) — build and run the C++ solver.
- [Reproducibility guide](../computational_scripts/README_REPRODUCIBILITY.md) — generate and run experiment commands.
- [Parameter reference](../cpp/parameters.md) — solver parameter reference.