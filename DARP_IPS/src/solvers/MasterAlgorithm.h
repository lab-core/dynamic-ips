...
public:
    ...
    virtual void solve(PInstance &pInst, int epoch, InputPaths &inputPaths, float subProTime) = 0;
    virtual void getIPSolution(const PInstance &pInst, int epoch, const InputPaths &inputPaths, float subProTime) = 0;
    ...
    bool hasTimeRemaining(const PInstance &pInst, float elapsedTime, int iteration);
    ...
    virtual void epochInitialization(PInstance &pInst, InputPaths &inputPaths, int epoch, const PGreedyModeler &GreedyModel) = 0;
    virtual bool shouldTerminate(const PInstance &pInst, float previousObj, float previousLpObj, int iter) = 0;
};
