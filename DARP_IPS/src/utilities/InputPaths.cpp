...
InputPaths::InputPaths(std::string datadir, std::string instanceName, double timeOUt)
    ...
    tripData_ = instanceDir + "TRIP_" + instanceName + ".txt";
    instanceData_ = instanceDir + "INSTANCE_" + instanceName + ".txt";
    durationData_ = instanceDir + "DURATION_" + instanceName + ".txt";
}
...
const std::string &InputPaths::getDurationData() const {return durationData_; }
